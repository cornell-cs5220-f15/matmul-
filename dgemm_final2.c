    ...
    for (j = 0; j < BLOCK_SIZE; j+=4) {
        ...
        */
        ...
        for (i = 0; i < BLOCK_SIZE; i+=4) {
            ...
            /*
            md0 = _mm256_fmadd(_mm256_load_pd(A+oi+16), mb16, md0);
            md0 = _mm256_fmadd(_mm256_load_pd(A+oi+20), mb20, md0);
            md0 = _mm256_fmadd(_mm256_load_pd(A+oi+24), mb24, md0);
            md0 = _mm256_fmadd(_mm256_load_pd(A+oi+28), mb28, md0);
            md0 = _mm256_fmadd(_mm256_load_pd(A+oi+32), mb32, md0);
            md0 = _mm256_fmadd(_mm256_load_pd(A+oi+36), mb36, md0);
            md0 = _mm256_fmadd(_mm256_load_pd(A+oi+40), mb40, md0);
            md0 = _mm256_fmadd(_mm256_load_pd(A+oi+44), mb44, md0);
            md0 = _mm256_fmadd(_mm256_load_pd(A+oi+48), mb48, md0);
            md0 = _mm256_fmadd(_mm256_load_pd(A+oi+52), mb52, md0);
            md0 = _mm256_fmadd(_mm256_load_pd(A+oi+56), mb56, md0);
            md0 = _mm256_fmadd(_mm256_load_pd(A+oi+60), mb60, md0);
            */
            ...
            /*
            mb16 = _mm256_permute4x64_pd(mb16, 0x39);
            mb20 = _mm256_permute4x64_pd(mb20, 0x39);
            mb24 = _mm256_permute4x64_pd(mb24, 0x39);
            mb28 = _mm256_permute4x64_pd(mb28, 0x39);
            mb32 = _mm256_permute4x64_pd(mb32, 0x39);
            mb36 = _mm256_permute4x64_pd(mb36, 0x39);
            mb40 = _mm256_permute4x64_pd(mb40, 0x39);
            mb44 = _mm256_permute4x64_pd(mb44, 0x39);
            mb48 = _mm256_permute4x64_pd(mb48, 0x39);
            mb52 = _mm256_permute4x64_pd(mb52, 0x39);
            mb56 = _mm256_permute4x64_pd(mb56, 0x39);
            mb60 = _mm256_permute4x64_pd(mb60, 0x39);
            */
