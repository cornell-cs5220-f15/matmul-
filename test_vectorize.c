...
inline void row8x8(unsigned int row, double * restrict A, double * restrict C,
    ...
    // // multiply
    // // left half
    // ymm00 = _mm256_mul_pd(ymm00, ymm16); ymm01 = _mm256_mul_pd(ymm01, ymm16);// row 1
    // ymm02 = _mm256_mul_pd(ymm02, ymm17); ymm03 = _mm256_mul_pd(ymm03, ymm17);// row 2
    // ymm04 = _mm256_mul_pd(ymm04, ymm18); ymm05 = _mm256_mul_pd(ymm05, ymm18);// row 3
    // ymm06 = _mm256_mul_pd(ymm06, ymm19); ymm07 = _mm256_mul_pd(ymm07, ymm19);// row 4
    // ymm08 = _mm256_mul_pd(ymm08, ymm20); ymm09 = _mm256_mul_pd(ymm09, ymm20);// row 5
    // ymm10 = _mm256_mul_pd(ymm10, ymm21); ymm11 = _mm256_mul_pd(ymm11, ymm21);// row 6
    // ymm12 = _mm256_mul_pd(ymm12, ymm22); ymm13 = _mm256_mul_pd(ymm13, ymm22);// row 7
    // ymm14 = _mm256_mul_pd(ymm14, ymm23); ymm15 = _mm256_mul_pd(ymm15, ymm23);// row 8
    // // add up
    // ymm00 = _mm256_add_pd(ymm00, ymm01); ymm02 = _mm256_add_pd(ymm02, ymm03);
    // ymm04 = _mm256_add_pd(ymm04, ymm05); ymm06 = _mm256_add_pd(ymm06, ymm07);
    // ymm08 = _mm256_add_pd(ymm08, ymm09); ymm10 = _mm256_add_pd(ymm10, ymm11);
    ...
    // // ++
    // ymm00 = _mm256_add_pd(ymm00, ymm08);// ymm00 now holds the entire left half, store back
    // _mm256_store_pd((double *) (C + row*8), ymm00);
    ...
    // // multiply
    // ymm00 = _mm256_mul_pd(ymm00, ymm24); ymm01 = _mm256_mul_pd(ymm01, ymm24);// row 1
    // ymm02 = _mm256_mul_pd(ymm02, ymm25); ymm03 = _mm256_mul_pd(ymm03, ymm25);// row 2
    // ymm04 = _mm256_mul_pd(ymm04, ymm26); ymm05 = _mm256_mul_pd(ymm05, ymm26);// row 3
    // ymm06 = _mm256_mul_pd(ymm06, ymm27); ymm07 = _mm256_mul_pd(ymm07, ymm27);// row 4
    // ymm08 = _mm256_mul_pd(ymm08, ymm28); ymm09 = _mm256_mul_pd(ymm09, ymm28);// row 5
    // ymm10 = _mm256_mul_pd(ymm10, ymm29); ymm11 = _mm256_mul_pd(ymm11, ymm29);// row 6
    // ymm12 = _mm256_mul_pd(ymm12, ymm30); ymm13 = _mm256_mul_pd(ymm13, ymm30);// row 7
    // ymm14 = _mm256_mul_pd(ymm14, ymm31); ymm15 = _mm256_mul_pd(ymm15, ymm31);// row 8
    ...
    // ymm00 = _mm256_add_pd(ymm00, ymm04); ymm08 = _mm256_add_pd(ymm08, ymm12);
    // // ++
    // ymm00 = _mm256_add_pd(ymm00, ymm08);// ymm00 now holds the entire right half, store back
    // _mm256_store_pd((double *) (C + row*8 + 4), ymm00); 
